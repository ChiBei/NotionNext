...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || 'Ted', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '记录生活', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://tedmosby.top/', // 网站地址
